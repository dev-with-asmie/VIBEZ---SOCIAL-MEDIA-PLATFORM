...
function LeftHome() {
    ...
    return (
        <div className={`w-[25%] hidden lg:block h-[100vh] bg-[black] border-r-2 border-gray-900 ${showNotification?"overflow-hidden":"overflow-auto"}`}>  
           ...
           <div className='flex items-center justify-between gap-[10px] px-[20px] border-b-2 border-b-gray-900 py-[10px]'> 
          ...
          <div className='text-blue-500 font-semibold cursor-pointer' onClick={handleLogOut}>   
           ...
           {/*suggested users*/}
           <div className='w-full flex flex-col gaap-[20px] p-[20px]'>
              <h1 className='text-[white] text-[19px] font-bold'>Suggested Users</h1>
