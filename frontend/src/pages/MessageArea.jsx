...
function MessageArea() {
    ...
    return (
        ...
        <div className='w-full h-[80px] fixed bottom-0 flex justify-center items-center bg-black z-[100]'> 
            ...
            <div onClick={()=>imageInput.current.click()}><IoMdImage className='w-[28px] h-[28px] text-white' /></div>
            {(input || frontendImage)&& <button className='w-[60px] h-[40px] rounded-full bg-gradient-to-br from-[#9500ff] to-[#ff0095] flex items-center justify-center cursor-pointer'><IoIosSend className='w-[25px] h-[25px] text-white'/></button>}
