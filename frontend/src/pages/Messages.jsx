    ...
    return (
        <div className='w-full min-h-[100vh] flex flex-col bg-black gap-[20px] p-[10px]'>  
            ...
            <div className='w-full h-[80px] flex items-center gap-[20px] px-[20px]'>
                        <MdKeyboardBackspace className='text-white cursor-pointer lg:hidden w-[25px] h-[25px]' onClick={()=>navigate(`/`)}/>
            ...
            <div className='w-full h-full overflow-auto flex flex-col gap-[20px]'>
                ...
                navigate("/messageArea");
                    ...
                    {onlineUsers?.includes(user?._id) && <div className='text-green-500 text-[15px]'>Active Now</div>}
                    <div className="flex flex-col">
