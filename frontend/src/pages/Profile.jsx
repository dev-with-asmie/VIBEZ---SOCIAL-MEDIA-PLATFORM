...
function Profile() {
    ...
    // 🔥 THIS MUST BE BEFORE ANY JSX THAT USES profileData
    if (!profileData) {
        return (
    ...
    return (
        <div className='w-full min-h-screen bg-gradient-to-b from-black to-gray-800'>
            <div className='w-full h-[80px] flex justify-between items-center px-[30px] text-white'>
                <div onClick={()=>navigate("/")}><MdKeyboardBackspace className='text-white cursor-pointer w-[25px] h-[25px]'/></div>
            ...
            <div className='w-full h-[150px] flex items-start gap-[20px] lg:gap-[50px] pt-[20px] px-[10px] justify-center'>
                ...
                <div className='w-[75px] h-[75px] md:w-[140px] md:h-[140px] border-2 border-black rounded-full cursor-pointer overflow-hidden'> 
  ...
  <div className="text-white text-[22px] md:text-[30px] font-semibold">
    {profileData?.following.length || 0}
            ...
            {profileData?._id != userData._id 
             && 
              <>
                 ...
                 {/* <button className='px-[10px] min-w-[150px] py-[5px] h-[40px] bg-[white] cursor-pointer rounded-2xl' onClick={()=>{dispatch(setSelectedUser(profileData));navigate("/messageArea")}}>Message</button> */}
                       <button className='px-[10px] min-w-[150px] py-[5px] h-[40px] bg-[white] cursor-pointer rounded-2xl' onClick={() => {dispatch(setSelectedUser(profileData));navigate("/messageArea");}}>Message
            </button>
        ...
        <div className='w-full min-h-[100vh] flex justify-center'> 
            <div className='w-full max-w-[900px] flex flex-col items-center rounded-t-[30px] bg-gradient-to-b from-black to-[#1e293b]
            relative gap-[20px] pt-[30px] pb-[100px]'> 
   ...
   {postType == "saved" && userData?.saved?.map((post)=>(
